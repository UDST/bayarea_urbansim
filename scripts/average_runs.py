...
run_nums = range(334, 384)
SAMPLE_SIZES = range(5, 40)
NUM_SAMPLES = 20

flds = "AGREMPN,FPSEMPN,HEREMPN,RETEMPN,MWTEMPN,OTHEMPN,HHINCQ1,HHINCQ2,HHINCQ3,HHINCQ4".split(',')
...
def variability_measure(dfs, N, M):
	...
	average_dfs = [average_random_N_dfs(dfs, M)
	               for i in range(N)]
